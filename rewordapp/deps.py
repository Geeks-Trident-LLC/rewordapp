...
Centralized registry for external dependency APIs used by the Reword Application`.
...
# Versioning
# Provides version metadata for RegexApp.
from regexapp import version as regexapp_version    # noqa
